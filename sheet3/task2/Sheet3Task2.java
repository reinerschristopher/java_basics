...
public class Sheet3Task2 {
	public static void main(String[] args) {
			...
			/* 
			 * Erkl�rung:
			 * Die Funktion clone() erzeugt kein neues Objekt der Klasse sheet3.task2.Sheep,
			 ...
			 * aber Objekte innerhalb des zu klonenden Objekts nicht (z.B. sheet3.task2.Fur).
			 ...
			 * Da sheet3.task2.Fur eine Unterklasse der Klasse sheet3.task2.Sheep ist, wird bei shallowClone() auf dasselbe
			 * Objekt MollyFur verwiesen, so dass sich die Felllaenge bei beiden Schafen �ndert.
			 * DeepClone() erzeugt auch f�r die Unterklasse sheet3.task2.Fur ein neues Objekt, so dass
			...
			/*
			 * siehe Implementierung in sheet3.task2.Sheep.java
			 */
